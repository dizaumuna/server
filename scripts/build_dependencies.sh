...
wget https://github.com/baksmali/smali/releases/download/3.0.9/baksmali-3.0.9-fat-release.jar -O baksmali.jar
wget https://github.com/baksmali/smali/releases/download/3.0.9/smali-3.0.9-fat-release.jar -O smali.jar
sudo mv baksmali.jar /usr/local/bin/
sudo mv smali.jar /usr/local/bin/
