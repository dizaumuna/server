...
# With new fspatch.py, we can directly use this python script to patch fs configs.
...
# without this, the building step will fail.
...
# compress super.img as zst
#zstd -8 super.img -o super.img.zst
