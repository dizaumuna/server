...
LOG_STEP_IN "Downloading LineageOS boot.img for miatoll..."
curl -# -L -o boot.img https://mirrorbits.lineageos.org/full/miatoll/20260323/boot.img

LOG_STEP_IN "Creating flashable ZIP file..."
zip -8 -r "miatoll_id_global-ota_full-OOS-user-14.0.zip" *
mv miatoll_id_global-ota_full-OOS-user-14.0.zip  ..
cd ..
