...
cat .currentport
LOG_STEP_IN "Downloading latest port OnePlus 8T firmware based on OxygenOS 14"
curl -# -L -o firmwareport.zip -O "https://gauss-componentotacostmanual-sg.allawnofs.com/remove-321c974e5931c5438d3cf3b7104102ac/component-ota/24/10/09/c6654c8a15d7487bb5a5c87708ad46af.zip"
echo "OnePlus 8T firmware based on OxygenOS 14" >> .currentport
LOG_STEP_IN "Finished downloading firmwares."
